...
static Texture * text = new BMPTexture("angel_copy.bmp");
...
void loadExternalTextures()			
{
	...
	// Load the texture.
	image[0] = getBMPData("angel_copy.bmp"); 
...
void loadProceduralTextures()			
{
	...
	// Specify an image as the texture to be bound with the currently active texture index.
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, 64, 64, 0, GL_RGBA, GL_UNSIGNED_BYTE, chessboard);
}
